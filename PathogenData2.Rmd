...
mod.GO.enrichment.BP.csv = write.csv(BPdf, file = "Tables/GOenrichmentCSV/enrichGO-BP.csv", 
                                     row.names = FALSE)
mod.GO.enrichment.MF.csv = write.csv(MFdf, file = "Tables/GOenrichmentCSV/enrichGO-MF.csv", 
                                     row.names = FALSE)
mod.GO.enrichment.CC.csv = write.csv(CCdf, file = "Tables/GOenrichmentCSV/enrichGO-CC.csv", 
                                     row.names = FALSE)
```
